...
(() => {
  ...
  function checkoutWA(){
    ...
    const text = encodeURIComponent(`Halo Customin.co,%0ASaya ingin order:%0A%0A${lines.join('%0A')}%0A%0ATotal: ${fmtIDR(total)}%0A%0A(From: ${location.href})`);
